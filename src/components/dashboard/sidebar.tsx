...
import { BookOpenText, ChevronDown, ClipboardList, LayoutDashboard, Mail, PawPrint, ShieldCheck, Stethoscope, UsersRound } from "lucide-react";
...
const navItems = [
  ...
  { to: "/campaigns", label: "Email Campaigns", icon: Mail, superAdminOnly: true },
